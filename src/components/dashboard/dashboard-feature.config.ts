...
const rootFeatures: Record<string, DashboardFeatureConfig> = {
  ...
  licenses: {
    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          ...
          { label: "Unlimited devices", value: "unlimited" },
        ],
      },
    ...
    listFields: [
      ...
      { label: "Device seats", source: "data", name: "seatLimit" },
...
const nestedFeatures: Record<string, DashboardFeatureConfig> = {
  "email/campaigns": {
    ...
    allowCreate: true,
    fields: [
      { name: "campaignName", label: "Campaign name", type: "text", source: "title", required: true },
      { name: "subject", label: "Subject", type: "text", source: "data" },
      { name: "previewText", label: "Preview text", type: "text", source: "subtitle" },
      {
        name: "recipientType",
        label: "Recipients",
        type: "select",
        ...
        options: [
          ...
          { label: "Custom subscriber list", value: "custom" },
        ],
      },
    ],
    listFields: [
      { label: "Campaign", source: "title" },
      { label: "Subject", source: "data", name: "subject" },
      { label: "Status", source: "status" },
      { label: "Recipients", source: "data", name: "recipientCount" },
      { label: "Opens", source: "data", name: "openCount" },
      { label: "Clicks", source: "data", name: "clickCount" },
